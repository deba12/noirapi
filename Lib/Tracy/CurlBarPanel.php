...
<script $nonce>
    ...
    const tracyCurlCallBack = document.querySelectorAll('.tracy-curl-click');

    const tracyCurlCallBackList = [...tracyCurlCallBack].map(el => {
