...
class SystemBarPanel implements IBarPanel {
    ...
    public function getTab(): string {
        ...
        $html .= $this->view->request->method . '[' . $this->view->request->controller . '::' . $this->view->request->function . '][' . basename($this->view->getLayout() ?? 'None') . '][' . $template . ']';
